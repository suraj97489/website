...
function Policy() {
  return (
    <div style={{ fontSize: "2rem", padding: "10rem 5rem" }}>
      <strong>Privacy Policy</strong>{" "}
      <p>
        Suraj Atigre built the salonkatta app as a Free app. This SERVICE is
        provided by Suraj Atigre at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at salonkatta unless
      ...
      <p>
        ...
        but not limited to Salon Name,Address,Name,Mobile,Email. The information
      ...
      <p>This policy is effective as of 2022-02-25</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at suraj97489@gmail.com.
      </p>{" "}
    </div>
  );
}
